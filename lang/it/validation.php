...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore di :attribute indicato è comparso in una fuga di dati nota. Scegli un :attribute diverso.',
    ],
    ...
    /*
     * Nomi campo in italiano usati al posto del nome tecnico della colonna
     * nei messaggi sopra (es. "Il campo Email è obbligatorio" invece di
     * "Il campo email è obbligatorio") — solo per i campi effettivamente
     * presenti nei form di questo progetto (auth, profilo, utenti,
     * riviste/numeri, contenuti).
     */
    'attributes' => [
        'name' => 'nome',
        'email' => 'email',
